            ...
            <div class="col-lg-6 col-7">  
              <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item " aria-current="page"><a href="/dashboard/penghuni">Kelola Penghuni</a></li>
                </ol>
              </nav>
            </div> 
          </div> 
                    ...
                    <table class="table table-striped table-hover table-bordered mydatatable"> 
                        <thead>
                          ...
                          @foreach( $penghuni as $k =>$hasil )
                            <tr align="center">
                                <td style="vertical-align: middle;" >{{ $k + $penghuni->firstitem() }}</td>

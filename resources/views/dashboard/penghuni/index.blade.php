                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item " aria-current="page"><a href="/dashboard/penghuni">Kelola
                                        Penghuni</a></li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <h2>Daftar Penghuni
                                            <a href="/dashboard/penghuni/create" style="margin: 10px;"
                                                class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Tambah
                                                    Penghuni</span></a>
                                        </h2>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($penghuni as $k => $hasil)
                                        <tr align="center">
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <br>
                                                <form action="{{ route('dashboard.penghuni.destroy', $hasil->id) }}" method="post"

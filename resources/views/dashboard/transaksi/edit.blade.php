            ...
            <div class="col-lg-6 col-7">  
              <nav aria-label="breadcrumb" class="d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item " aria-current="page">Edit Transaksi</li>
                </ol>
              </nav>
            </div> 
          </div>
                    ...
                    <div class="container">
                          ...
                          <form id="contact-form" role="form">
                              <div class="controls">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group"> <label for="form_email">Tanggal Bayar :</label> <input id="form_email" type="text" name="email" class="form-control" placeholder="Please enter your age *" value="20-02-2021" readonly > </div>
                                        </div>
                                        <div class="col-md-6">

                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status_penghuni"
                                                                ...
                                                                <option value="{{ $penghuni->status_penghuni }}">
                                                                    {{ $penghuni->status_penghuni }}</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="form_name">Foto KTP
                                                                ...
                                                                :</label>
                                                            <div class="col-sm-10">
                                                                <img src="{{ asset('/storage/assets/upload/penghuni/foto_ktp/' . $penghuni->images->where('type', 'ktp')->first()->image_name) }}"
                                                                    alt class="img-thumbnail img-preview2">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="form_name">Foto Surat Nikah
                                                                <span class="text-red">*( Wajib Diisi Bila Sudah
                                                                    Menikah )</span>
                                                                :</label>
                                                            <div class="col-sm-10">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="custom-file">
                                                                    <input type="file"
                                                                        ...
                                                                        id="foto_kk" name="foto_kk" onchange="previewImg4()"
